...
class LoginForm extends BaseModel
{
    ...
    {
        return [
            [['username', 'password', 'verify_code'], 'required','message'=>Yii::t('app','must')],
    ...
    public function login()
    {
        if ($this->validate()) {
			...
			$model = SchoolUser::findOne($userData->id);
    ...
    {
        if ($this->_user === NULL) {
            $this->_user = SchoolUser::findByUsername($this->username);
        }
        return $this->_user;
    }
}

...
<div class="page-container">
    <article class="page-container">
        ...
        <?= $form->field($model, 'types')->textInput(['class' => 'input-text', 'placeholder' => '本地或外网上传']) ?>
        <?= $form->field($model, 'title')->textInput(['class' => 'input-text', 'placeholder' => '标题']) ?>
        <?= $form->field($model, 'course_id')->textInput(['class' => 'input-text', 'placeholder' => '内容']) ?>
        <?= $form->field($model, 'course_url')->textInput(['class' => 'input-text', 'placeholder' => '课件上传路径']) ?>

...
<div class="page-container">
    <article class="page-container">
        ...
        <?= $form->field($model, 'password_hash')->passwordInput(['class' => 'input-text', 'placeholder' => '密码']) ?>
        ...
        <div style="display: none;"><?= $form->field($model, 'created_at')->hiddenInput(['class' => 'input-text', 'value' =>time()])?></div>

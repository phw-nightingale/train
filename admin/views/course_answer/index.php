    ...
    <table class="table table-border table-bordered table-hover table-bg">
        <form>
            ...
            <tr class="text-c">
                ...
                <th><?= $ClassModel->getAttributeLabel('ask_id') ?></th>
                <th><?= $ClassModel->getAttributeLabel('course_id') ?></th>
                <th><?= $ClassModel->getAttributeLabel('answer') ?></th>
                <th><?= $ClassModel->getAttributeLabel('is_correct') ?></th>

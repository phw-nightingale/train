...
<div class="page-container">
    <article class="page-container">
        ...
        <?= $form->field($model, 'subject')->textInput(['class' => 'input-text', 'placeholder' => '题目']) ?>
        <?= $form->field($model, 'content')->textInput(['class' => 'input-text', 'placeholder' => '内容']) ?>
        <?= $form->field($model, 'types')->textInput(['class' => 'input-text', 'placeholder' => '类型']) ?>
        <?= $form->field($model, 'answer')->textInput(['class' => 'input-text', 'placeholder' => '答案']) ?>
        <?= $form->field($model, 'score')->textInput(['class' => 'input-text', 'placeholder' => '考试得分']) ?>

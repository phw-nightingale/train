...
class Course_typeController extends BaseController
{
    ...
    {
        $this->ClassModel = new \common\models\CourseType;
    }
    ...
    public function actionIndex()
    {
        ...
        $pages = new Pagination(['totalCount' => $search->count(), 'pageSize' => '5']);
    ...
    public function actionCreate()
    {
        ...
        if ($ClassModel->load(Yii::$app->request->post()) && $ClassModel->validate()) {
           ...
           /* $ClassModel->status=Yii::$app->request->post('status');*/
            if ($ClassModel->save()) {
